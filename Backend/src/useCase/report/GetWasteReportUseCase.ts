...
export interface IGetWasteReportUseCase {
  execute(dto: WasteReportRequestDTO): Promise<WasteReportResponseDTO>;
}

export class GetWasteReportUseCase implements IGetWasteReportUseCase {
