...
exports.PreviewAllocationUseCase = void 0;
const LotModel_1 = require("../../frameWork/database/models/LotModel");
class PreviewAllocationUseCase {
    stapleCategories = ['Grains', 'Canned Goods', 'Dry Goods', 'Produce', 'Bakery'];
    async execute(dto) {
        const policy = dto.allocationPolicy || 'FEFO';
        const allocatedLots = [];
        ...
        for (const line of dto.items) {
            ...
            const candidateDocs = await LotModel_1.LotModel.find({
...
exports.PreviewAllocationUseCase = PreviewAllocationUseCase;
